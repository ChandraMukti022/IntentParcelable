    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Chandra Mukti Gimnastiyar");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Chandra Mukti Gimnastiyar");
                mPerson.setAge(17);
                mPerson.setEmail("candramukti022@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "08995969551";
